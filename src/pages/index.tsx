                    ...
                    <div className="mb-6">
                        ...
                        <div className="mb-40">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
                                <div className="border h-60 p-2 rounded bg-white">
                                    <p className="text-center">半年に一度の食事会</p>
                                </div>
                                <div className="border h-60 p-2 rounded bg-white">
                                    <p className="text-center">Tukky Note</p>
                                </div>
                                <div className="border h-60 p-2 rounded bg-white">
                                    <p className="text-center">Tukky Lab</p>
                                </div>
                            </div>
                        </div>
